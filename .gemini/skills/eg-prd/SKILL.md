...
- `multiSelect`: `true`
- `options`:
  1. **Save as `docs/prds/<slug>-<YYYY-MM-DD>.md`** — "Durable artifact. Recommended for anything Standard or Comprehensive."
...
- Patterns to mirror: <e.g. "uses ASE ExtXYZ trajectory reading, numpy FFT, scipy.signal windowing">
- Constraints from GEMINI.md or recent decisions: <detailed balance, zero-point factors, unit conventions>
...
**STOP.** Do NOT commit. Wait for the user's explicit commit instruction.
